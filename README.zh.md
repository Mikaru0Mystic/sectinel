...
**🌐 [English](README.md) · [Español](README.es.md) · 中文 · [Français](README.fr.md) · [Deutsch](README.de.md) · [Português](README.pt.md) · [日本語](README.ja.md)**
...
Sectinel 是军火库，它能在任何兼容 agentskills.io 的智能体上独立运作。如果你想要一个能自动驾驭
它的操作员，**[Breachproof](https://github.com/Mikaru0Mystic/breachproof)** 是围绕这套库构建的
自主智能体：它拿起技能、运行扫描器，把一个代码库推进到「零发现」。完全可选；Sectinel 本身就已
足够好用。
